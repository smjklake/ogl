...
int main( void )
{
	...
	window = glfwCreateWindow( 1024, 768, "Tutorial 10 - Transparency", nullptr, nullptr);
	if( window == nullptr){
	...
	const GLuint programID = LoadShaders( "StandardShading.vertexshader", "StandardTransparentShading.fragmentshader" );
