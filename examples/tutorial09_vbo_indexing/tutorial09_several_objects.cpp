...
int main( void )
{
	...
	window = glfwCreateWindow( 1024, 768, "Tutorial 09 - Rendering several models", nullptr, nullptr);
	if( window == nullptr){
	...
	const GLuint programID = LoadShaders( "StandardShading.vertexshader", "StandardShading.fragmentshader" );
