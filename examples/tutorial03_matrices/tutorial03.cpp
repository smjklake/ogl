...
int main( void )
{
	...
	window = glfwCreateWindow( 1024, 768, "Tutorial 03 - Matrices", nullptr, nullptr);
	if( window == nullptr){
	...
	const GLuint programID = LoadShaders( "SimpleTransform.vertexshader", "SingleColor.fragmentshader" );
